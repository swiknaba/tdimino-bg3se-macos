...
**Version:** v0.36.7 | **Feature Parity:** ~77%
...
| Ext.Entity | ✅ GUID lookup, **1,999 components registered** (462 layouts: 169 verified + 293 generated), **1,577 ARM64 sizes** + **702 Windows estimates** = **1,730 total** (87% coverage) |
