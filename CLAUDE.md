...
**Version:** v0.33.0 | **Parity:** ~66% | **Target:** Full Windows BG3SE mod compatibility
...
- **Ext.StaticData** - Immutable game data (Feat type with **Name resolution**: GetAll, Get, LoadFridaCapture)
