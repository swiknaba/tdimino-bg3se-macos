...
**Version:** v0.36.16 | **Parity:** ~82% | **Target:** Full Windows BG3SE mod compatibility
...
- **Ext.Types** - Full reflection API (6 functions): GetAllTypes (~2050), GetTypeInfo, GetObjectType, TypeOf, IsA, Validate
