...
- **Ext.Entity** - GUID lookup, **1,999 components registered** (462 layouts: 169 verified + 293 generated), **1,577 ARM64 sizes**, **1,730 with any size** (87% via unified database), GetByHandle
