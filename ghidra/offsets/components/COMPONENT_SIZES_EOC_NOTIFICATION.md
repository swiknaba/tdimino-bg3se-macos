...
| eoc::notification::CharacterChangedAppearanceComponent | 304 | `* 0x130` pattern |  |
| eoc::notification::CharacterCreatedComponent | 992 | `* 0x3e0` pattern |  |
| eoc::notification::CinematicArenaScriptEventComponent | 48 | `* 0x30` pattern |  |
| eoc::notification::CombatantKilledNotificationComponent | 40 | `* 0x28` pattern |  |
| eoc::notification::CombineResultCreatedComponent | 48 | `* 0x30` pattern |  |
| eoc::notification::ConcentrationChangedComponent | 0x88 | 136 | Concentration changed |
| eoc::notification::DestinationComponent | 48 | `* 0x30` pattern |  |
| eoc::notification::DropInApprovalPendingNotificationComponent | 2 | `<< 1` pattern |  |
| eoc::notification::DropInApprovalRequestNotificationComponent | 40 | `* 0x28` pattern |  |
| eoc::notification::DropInApprovedNotificationComponent | 2 | `<< 1` pattern |  |
| eoc::notification::DropInCanceledRequestNotificationComponent | 4 | `<< 2` pattern |  |
| eoc::notification::EndCreditsRequestedComponent | 4 | `<< 2` pattern |  |
| eoc::notification::EnemySightedComponent | 0x18 | 24 | Enemy sighted |
| eoc::notification::EnterPhotoModeFailedNotificationComponent | 1 | `(ulong)(uVar3 >> 0x10)` (no multiplier) |  |
| eoc::notification::EntityReceivedComponent | 32 | `<< 5` pattern |  |
| eoc::notification::FailedPrivateDialogJoinAttemptNotificationComponent | 72 | `* 0x48` pattern |  |
| eoc::notification::GatherAtCampCheckComponent | 2 | 0x2 | AddComponentUnchecked<eoc::notification::GatherAtCampCheckComponent> |
| eoc::notification::InventoryMembersCreatedNotificationComponent | 16 | `<< 4` pattern |  |
...
| eoc::notification::LongRestCancelComponent | 8 | `<< 3` pattern |  |
| eoc::notification::ModifySpellCameraFocusNotificationComponent | 40 | `* 0x28` pattern |  |
| eoc::notification::MovieEndFadeInRequestNotificationComponent | 48 | `* 0x30` pattern |  |
| eoc::notification::NewMemberAddedToPlayerInventoryNotificationComponent | 32 | `<< 5` pattern |  |
| eoc::notification::NotifyInventoryNotificationComponent | 16 | `<< 4` pattern |  |
...
| eoc::notification::ProfileUpdateNotificationComponent | 8 | `<< 3` |  |
| eoc::notification::RandomCastResultComponent | 0x50 | 80 | Random cast result |
| eoc::notification::RecipesUnlockedNotificationComponent | 48 | `* 0x30` |  |
| eoc::notification::ReposeResultComponent | 1 | 0x1 | AddComponentUnchecked<eoc::notification::ReposeResultComponent> |
| eoc::notification::ResetTutorialsMessageRequestNotificationComponent | 8 | `<< 3` |  |
...
| eoc::notification::SpellCastDestroyedComponent | 16 | `<< 4` |  |
...
| eoc::notification::TimelineBackgroundActorRequestComponent | 48 | `* 0x30` |  |
| eoc::notification::TradeEventComponent | 0x10 | 16 | Trade event |
| eoc::notification::TutorialHideRequestComponent | 16 | `<< 4` |  |
| eoc::notification::TutorialShowRequestComponent | 16 | `<< 4` |  |
...
| eoc::notification::WeaponDisarmedNotificationComponent | 16 | `<< 4` |  |
